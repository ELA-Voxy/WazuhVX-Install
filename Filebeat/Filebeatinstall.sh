...
tar -xf ./wazuh-certificates.tar -C /etc/filebeat/certs/ ./node-1.pem ./node-1-key.pem ./root-ca.pem
mv -n /etc/filebeat/certs/node-1.pem /etc/filebeat/certs/filebeat.pem
mv -n /etc/filebeat/certs/node-1-key.pem /etc/filebeat/certs/filebeat-key.pem
